...
export function NoteCard({
  ...
  useEffect(() => { onHeightChange() }, [isCollapsed, labSaved])
    ...
    <>
      ...
      >
        ...
        <div className="pt-3 px-3">
          ...
          {contextHtml && (
            <div className="bg-secondary text-secondary-foreground text-[10px] italic px-2 py-0.5 rounded truncate w-[90%] mb-2">
              {contextHtml}
            </div>
          )}
        </div>
      ...
      {isOverlayActive && screenshotHtml && (
        <div
          className="fixed inset-0 z-[2147483647] bg-black/80 flex items-center justify-center cursor-zoom-out p-4"
